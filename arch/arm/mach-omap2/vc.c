 ...
 * @ret:	Are we interested in retention or OFF?
 *
 ...
 */
static int __init omap_vc_setup_lp_time(struct voltagedomain *voltdm, bool ret)
{
...
void __init omap_vc_init_channel(struct voltagedomain *voltdm)
{
	...
	voltdm->rmw(voltdm->vfsm->voltsetupoff_mask,
