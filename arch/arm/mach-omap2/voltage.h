 ...
 * data
 * @voltsetup_mask: SETUP_TIME* bitmask in the PRM_VOLTSETUP* register(RET/SLEEP)
 ...
 * @voltsetupoff_mask: SETUP_TIME* bitmask in the PRM_VOLTSETUP*_OFF register
